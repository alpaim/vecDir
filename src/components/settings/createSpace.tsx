import type { EmbeddingBackendType, EmbeddingConfig, LLMConfig } from "@/lib/vecdir/bindings";
                            ...
                            {field => (
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={value => field.handleChange(value as EmbeddingBackendType)}
                                    >
